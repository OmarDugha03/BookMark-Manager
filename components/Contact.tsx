  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 lg:p-4 bg-[#5368df] mt-20">
      ...
      <form
        ...
        <button className="inline-block w-full lg:w-[30%]  h-full px-6 mt-16 py-3 text-center lg:my-5 lg:mx-4  group-invalid:pointer-events-none group-invalid:opacity-30 transition-all duration-200 ease-in-out delay-100 bg-gradient-to-br text-white bg-orange-400 hover:bg-slate-50 hover:text-orange-400 hover:bg-transparent border border-transparent  focus:ring-2 focus:outline-none focus:ring-orange-400 hover:border hover:border-orange-400 shadow-sm font-medium rounded-lg text-sm ">
          Contact Us
        </button>
      </form>
    </div>
